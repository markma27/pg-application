...
export const entityInputSchema = z.object({
    ...
    abn: z.string().optional().default("").refine((v) => v === "" || /^\d{11}$/.test(v), { message: "ABN must be exactly 11 digits" }),
    tfn: z.string().optional().default("").refine((v) => v === "" || /^\d{8,9}$/.test(v), { message: "TFN must be 8 or 9 digits" }),
...
export function toApplicationInput(full) {
    return {
